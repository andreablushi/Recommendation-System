...
After training the classifier, it's possible to visualize the learned decision rules by plotting the decision tree using built-in \textit{scikit-learn} functionality.  
